...
const Index = () => {
  return (
    <div className="h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-slate-50 relative flex flex-col overflow-hidden">
      ...
      {/* Main content */}
      <main className="relative z-10 max-w-5xl mx-auto px-6 flex-1 flex flex-col justify-center">
        {/* Hero section */}
        <div className="text-center mb-5">
          <div className="flex items-center justify-center gap-6 mb-3">
            <img src={logoCacau} alt="Grupo Cacau" className="h-20 w-auto object-contain" />
            <div className="w-px h-12 bg-slate-200" />
            <img src={logoValeMilk} alt="ValeMilk" className="h-20 w-auto object-contain" />
            <div className="w-px h-12 bg-slate-200" />
            <img src={logoValeFish} alt="ValeFish" className="h-20 w-auto object-contain" />
          </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-3">
          {apps.map((app) => (
            <a
              ...
              className={`group relative bg-white rounded-xl border border-slate-100 ${app.hoverBorder} p-3 transition-all duration-300 hover:shadow-lg hover:shadow-slate-200/50 hover:-translate-y-0.5 active:translate-y-0 active:shadow-md flex items-start gap-3`}
            >
              <div className={`w-9 h-9 rounded-lg ${app.bg} flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform duration-300`}>
                <app.icon className={`w-4.5 h-4.5 ${app.iconColor}`} />
              </div>
              <div className="flex-1 min-w-0">
                ...
                <span className={`inline-flex items-center gap-1 px-2.5 py-1 rounded-md bg-gradient-to-r ${app.color} text-white text-xs font-semibold shadow-sm group-hover:shadow-md transition-all duration-300 w-fit mt-2`}>
                  Acessar
